...
export function generateSidebarStyles(config) {
  const styles = {
    width: config.width,
...
export function generateHeaderStyles(config) {
  const styles = {
...
export function generateContentStyles(config) {
  const styles = {
    transition: 'all 0.3s ease',
  };
